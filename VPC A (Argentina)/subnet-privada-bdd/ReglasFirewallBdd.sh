...
iptables -A INPUT -s 10.1.10.0/24 -d 0.0.0.0/0 -p tcp --sport 1024:65535 --dport 22 -m state --state NEW -j ACCEPT
# Permitir SSH desde la VPN
...
iptables -A INPUT -s 10.1.10.0/24 -d 0.0.0.0/0 -p tcp --sport 1024:65535 --dport 3306 -m state --state NEW -j ACCEPT
